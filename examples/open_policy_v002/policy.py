"""Editable Strategy 3 rule baseline – modified constants for improved Pk and survival. v2: increased ranges, relaxed heading errors, extended crank."""
...
class Policy:
    """Strong editable seed: Strategy 3 fallback with tuned constants and visibility check."""
